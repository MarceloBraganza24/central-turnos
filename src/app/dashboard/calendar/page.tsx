      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <div className="flex gap-2">
          <a
            ...
            className="rounded-xl border border-neutral-700 px-4 py-2 text-sm hover:bg-[var(--card)]"
          >
            Configuración
          </a>
          <button
                    ...
                    >
                      ...
                      <div className="mt-3">
                        ...
                        <select
                          ...
                          className="w-full rounded-lg border border-neutral-700 bg-[var(--card)] px-3 py-2 text-xs text-[var(--foreground)] disabled:opacity-60"
                        >
